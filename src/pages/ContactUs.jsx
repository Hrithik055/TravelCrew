      ...
      <div className="mb-10 mt-24">
            ...
            <div className="w-full flex flex-col items-center justify-center">
              <div className="flex flex-col items-center justify-center p-3 shadow-lg rounded-lg">
                ...
                <div className="pt-5 pb-5 pl-5 pr-5 mt-3 mb-5 shadow-lg rounded-lg">
                  ...
                  <p>
                    <strong>Phone:</strong> +91-6204889115
                  </p>
                  <p>
                    <strong>Email:</strong> TravelCrew@gmail.com
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col w-2/4 items-center justify-center max-md:w-full max-md:mt-10">
            ...
            <div className="flex flex-col items-start justify-center p-5">
              <Accordion
                ...
                content={
                  "Booking a tour is simple. Browse our tour packages, select your preferred tour, and contact us via the form or call +91-6204889115. Complete your booking and payment online."
                }
              />
              <Accordion
        ...
        <div className="w-full flex flex-col items-center justify-center mt-10 mb-10">
          ...
          <div className="w-full flex flex-col items-center justify-center">
            <p>
              ...
              <a
                href="https://www.instagram.com/travelll_crew?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                target="_blank"
                rel="noopener noreferrer"
                className="pl-5 pr-5"
              >
        ...
        <div className="flex flex-row items-center justify-center">
          <p className="text-center">
            ...
            emergencies, please call: +91-6204889115, Email: Travelcrew@gmail.com
          </p>
        </div>
      </div>
    </>
